...
public class CodeGenerator {
    ...
    private static String author ="meizijiu";//作者名称
    private static String outputDir ="/Users/admin/Desktop/";//生成的位置
    ...
    private static String password ="08107659";//数据库密码
    private static String tablePrefix ="t_";//数据库表的前缀，如t_user
    private static String parentPackage = "com.bdqn.erp";//顶级包结构
